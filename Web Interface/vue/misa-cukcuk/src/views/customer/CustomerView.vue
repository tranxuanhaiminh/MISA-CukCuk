<template>
  <div class="page">
    <div class="page-head">
      <div class="page-head-text text-heading">Danh sách {{entity}}</div>
      <BaseIconButton
        btnid="addEmp"
    ...
    <BasePagination :entity="entity"/>
    <BaseLoading :isHide='isLoading'/>
  </div>
</template>
...
import BaseCbx from "../../components/base/BaseCbx.vue";
